  ...
  return (
    <div className="px-8 py-8 max-w-2xl">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-sand-900 dark:text-white tracking-tight">New contact</h1>
        <p className="text-sand-500 dark:text-sand-400 text-sm mt-1">Add someone to your network.</p>
      </div>
